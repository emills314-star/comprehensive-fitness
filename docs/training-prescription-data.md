...
| Mesocycle plan and candidate pools | `mesocycle/1.0.0` | `schemas/mesocycle-plan.v1.schema.json` | Primary, alternative, lower-fatigue, and specialization plans; evidence-derived 2–12 week duration; lifecycle; available days/split/equipment; productive lifts preserved across transitions; diversified pools of no more than five candidates per muscle; active subset; outcome and review |
