...
| Mesocycle plan and candidate pools | `mesocycle/2.0.0` | `schemas/mesocycle-plan.v1.schema.json` | Primary, alternative, lower-fatigue, and specialization plans; evidence-derived 2–12 week duration; explicit lifecycle; constraints; diversified pools of no more than five alternatives per program slot; selected portfolio; distributed sessions; muscle plans; full-program interaction review; outcome and review |
