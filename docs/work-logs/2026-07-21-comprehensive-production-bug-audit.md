...
- Published application commit `6361959` to GitHub `main`. Cache-bypassing production reads confirmed `comprehensive-fitness-pwa-v57`, the empty-template guards, and the readiness-domain normalization; the two focused regressions passed 4/4 on deployed mobile and desktop projects.
