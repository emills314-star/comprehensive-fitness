...
- Continuation hosted verification: production exposed commit `6361959` markers in the cache, template, and workout assets; the focused empty-template and settings-domain regressions passed 4/4 across mobile and desktop against Vercel.
