...
Generation order is objective/schedule/equipment/scope; evidence-adjusted direct-volume targets; muscle priority; major compounds/high-value lifts; session distribution and recovery; secondary/isolation work; hard daily-limit enforcement; direct/secondary volume calculation; automatic balancing; then unresolved actionable review. Major program muscles are allocated before smaller supplemental muscles. Direct work counts 1.0, meaningfully mapped secondary work counts 0.35, and incidental involvement or stabilization counts zero. Secondary contribution can prevent unnecessary accessories but cannot silently satisfy a major muscle's direct-set minimum.
