(function (root, factory) {
  ...
  const SUPPORTED_APP_DATA_VERSION = 2;
  ...
  function validateAndSanitizeBackup(input, options = {}) {
    ...
    if (Number(input.appDataVersion) !== SUPPORTED_APP_DATA_VERSION) {
      fail("appDataVersion must be " + SUPPORTED_APP_DATA_VERSION + ".");
    }
    ...
    backup.appDataVersion = SUPPORTED_APP_DATA_VERSION;
